...
VOICE = {
    ...
    "volgrin": {
        ...
        "head": ("Broad", "Wind", "Open", "Far", "Standing", "Grass", "Dust"),
    ...
    "valran": {
        ...
        "head": ("High", "Stone", "Winter", "Cairn", "Rough", "Far", "Bleak", "Wether"),
        "tail": ("steading", "fold", "shieling", "howe", "burn", "brae", "rigg"),
